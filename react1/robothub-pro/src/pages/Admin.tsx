...
export default function Admin() {
  ...
  return (
    <div className="space-y-10">
      <header className="flex flex-col gap-4 rounded-3xl border border-zinc-200 bg-white px-6 py-8 shadow-sm dark:border-zinc-700 dark:bg-zinc-900 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-sm font-medium uppercase tracking-wide text-blue-600 dark:text-blue-400">Operations control</p>
          <h1 className="text-3xl font-semibold text-zinc-900 dark:text-zinc-100">Admin control center</h1>
          <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
            Logged in as {user.email}. Monitor fulfillment, inventory, and customer success in real time.
          </p>
        </div>
        <button
          onClick={logout}
          className="self-start rounded-full border border-zinc-300 px-4 py-2 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-100 dark:border-zinc-600 dark:text-zinc-200 dark:hover:bg-zinc-800"
        >
          Sign out
        </button>
      </header>
      ...
      <section className="grid gap-6 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
        ...
        <aside className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
          <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Live alerts</h2>
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
        <article className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
          <header className="flex items-center justify-between border-b border-zinc-200 px-6 py-4 dark:border-zinc-700">
            <div>
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400">Key enterprise customers</p>
            </div>
        ...
        <aside className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
          <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Team focus</h2>
          <ul className="space-y-3 text-sm">
            {team.map(member => (
